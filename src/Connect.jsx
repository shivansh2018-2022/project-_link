                    ...
                    <React.Fragment>
                        ...
                        <div className='flex items-center justify-center h-screen'>
                            <div className='p-4 rounded-lg shadow-md w-64 bg-white flex flex-col items-center'>
                                <h2 className='text-lg font-bold mb-4'>Elevate Your Mindset</h2>
                                <p className='text-center mb-4'>Ready to elevate your mindset? Dive into our Quote Generator for daily doses of wisdom and inspiration.</p>
